/************************** PKINHY36.c ***************************************/
/*downloaded 071002 from http://cci.lbl.gov/hybrid_36/ 
  (which is slightly different from version a few weeks earlier)
  as suggested below:
  PKINHY36.h mod of hybrid_36_c.h for prototypes of hy36encode(), hy36decode() 
  and the include from PHENIX iotbx is commented out, 071002 dcr
*/
